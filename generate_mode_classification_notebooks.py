#!/usr/bin/env python3
"""
Generate FLSTM Classification Metric Notebooks — Mode Threshold
...
Uses MODE of training diffs as the dynamic threshold tau.
"""
import json, os, copy
...
def build_main_cell(arch_label, mf_label, dataset_label, dataset_key):
    ...
    src = dl + [
        ...
        "\n",
        "# ============================================================\n",
        "# TRAINING & EVALUATION (30 runs, No Noise)\n",
        "# ============================================================\n",
        f"print('\\n' + '='*80)\n",
        ...
        "    # Round diffs to 2 decimal places before computing mode (continuous data)\n",
        "    train_diffs_rounded = np.round(train_diffs, 2)\n",
        "    mode_result = scipy_mode(train_diffs_rounded, keepdims=True)\n",
        "    tau = round(float(mode_result.mode[0]), 6)\n",
        "    \n",
...
# ============================================================
# GENERATION — EPL, MackeyGlass, Sunspots (Mode)
# ============================================================
datasets = {
    'epl': {'label': 'EPL', 'folder': 'FLSTM_Classification_EPL_Mode'},
    'mackey_glass': {'label': 'Mackey-Glass', 'folder': 'FLSTM_Classification_MackeyGlass_Mode'},
    'sunspots': {'label': 'Sunspots', 'folder': 'FLSTM_Classification_Sunspots_Mode'},
}
        ...
        for mf in ['dog', 'sg', 'gb']:
            ...
            title_cell = {
                ...
                "source": [
                    ...
                    "\n",
                    "**Classification Metrics Evaluation (No Noise) — Mode Threshold**"
                ]
            }
