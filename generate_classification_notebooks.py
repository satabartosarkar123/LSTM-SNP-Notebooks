...
# ============================================================
datasets = {
    'epl': {'label': 'EPL', 'folder': 'FLSTM_Classification_EPL'},
    'mackey_glass': {'label': 'Mackey-Glass', 'folder': 'FLSTM_Classification_MackeyGlass'},
    'sunspots': {'label': 'Sunspots', 'folder': 'FLSTM_Classification_Sunspots'},
}
